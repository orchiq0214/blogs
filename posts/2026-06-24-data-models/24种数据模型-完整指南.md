...
![REDCAPE 7 大用途](images-24models/fig-2-redcape.png)

### 1.2 6 大分类：24 个模型的全景图

按数学形式和应用领域，我把 24 个模型重新归并为 **6 大类**，方便数据分析师按场景检索：

![6 大分类框架](images-24models/fig-1-classification.png)
...
![分布对比](images-24models/fig-3-distribution.png)
...
![网络模型](images-24models/fig-4-network.png)
...
![结语](images-24models/fig-conclusion.png)
